...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./SOKAR1.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("SK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S SOKAR1 -X kill
screen -S SOKAR1 ./SOKAR1
done
]])  
file:close() 
...
if hash or SudoBot(msg) or DevSOKAR1(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevSOKAR1(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevSOKAR1(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevSOKAR1(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevSOKAR1(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevSOKAR1(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevSOKAR1(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local SOKAR1_Msg = ''  
if msgs < 100 then 
SOKAR1_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
SOKAR1_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
SOKAR1_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
SOKAR1_Msg = 'متفاعل' 
elseif msgs < 1200 then 
SOKAR1_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
SOKAR1_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
SOKAR1_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
SOKAR1_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
SOKAR1_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
SOKAR1_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
SOKAR1_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
SOKAR1_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
SOKAR1_Msg = 'رب التفاعل'  
end 
return SOKAR1_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@KK_90")  
...
--------------------------------------------------------------------------------------------------------------
function SourceSOKAR1(msg,data) -- بداية العمل
if msg then
...
if DevSOKAR1(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,SOKAR1_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ❃' and DevSOKAR1(msg) then  
...
if text == 'تعطيل التواصل ❃' and DevSOKAR1(msg) then  
...
if text == 'تفعيل البوت الخدمي ❃' and DevSOKAR1(msg) then  
...
if text == 'تعطيل البوت الخدمي ❃' and DevSOKAR1(msg) then  
...
if text == 'ضع كليشه ستارت ❃' and DevSOKAR1(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ❃∫ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ❃' and DevSOKAR1(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ❃' and DevSOKAR1(msg) then 
...
if text == 'تحديث السورس ❃' and DevSOKAR1(msg) then 
os.execute('rm -rf SOKAR1.lua')
os.execute('wget https://raw.githubusercontent.com/SOKAR1/main/SOKAR1.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس سكر\n ❃∫ الاصدار » { 1.3v}')
dofile('SOKAR1.lua')  
end
if text == 'الاصدار ❃' and DevSOKAR1(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس سكر \n ❃∫ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ❃' and DevSOKAR1(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/SOKAR1_R) \n ❃∫ [قناه السورس](t.me/pvv_v)')
end
if text == "ضع اسم للبوت ❃" and DevSOKAR1(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ❃' and DevSOKAR1(msg) then 
...
if text == 'المشتركين ❃' and DevSOKAR1(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ❃' and DevSOKAR1(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❃") and DevSOKAR1(msg) then
...
if text == ("قائمه العام ❃") and DevSOKAR1(msg) then
...
if text == ("قائمه الكتم العام ❃") and DevSOKAR1(msg) then
...
if text=="اذاعه خاص ❃" and msg.reply_to_message_id_ == 0 and DevSOKAR1(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ❃" and msg.reply_to_message_id_ == 0 and DevSOKAR1(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ❃" and msg.reply_to_message_id_ == 0 and DevSOKAR1(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ❃" and msg.reply_to_message_id_ == 0  and DevSOKAR1(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ❃" and msg.reply_to_message_id_ == 0  and DevSOKAR1(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❃' and DevSOKAR1(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❃" and DevSOKAR1(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ❃" and DevSOKAR1(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الكروبات الان » { '..#group..' }'..SOKAR1k..''..SOKAR1..'\n❃∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevSOKAR1(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevSOKAR1(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevSOKAR1(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevSOKAR1(msg) then
...
local SOKAR11_Msg = database:get(bot_id.."SOKAR11:Add:Filter:Rp2"..text..msg.chat_id_)   
if SOKAR11_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if SOKAR1_Msg and not Special(msg) then  
local SOKAR1_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if SOKAR1_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSOKAR1(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevSOKAR1(msg) then
...
os.execute('rm -rf SOKAR1.lua')
os.execute('wget https://raw.githubusercontent.com/SOKAR1/SOKAR1/main/SOKAR1.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس سكر\n ❃∫ الاصدار » { 1.3v}')
dofile('SOKAR1.lua')  
end

if text and text:match("^تغير الاشتراك$") and DevSOKAR1(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevSOKAR1(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ❃" and DevSOKAR1(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ❃∫ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❃$") and DevSOKAR1(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❃" and DevSOKAR1(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❃" and DevSOKAR1(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ❃∫ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ❃" and DevSOKAR1(msg) then  
...
database:sadd(bot_id.."SOKAR1:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."SOKAR1:blocname"..msg.chat_id_)
...
function KK_90_name(t1,t2)
if t2.id_ then 
name_SOKAR1 = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_SOKAR1 then 
names_SOKAR1 = database:smembers(bot_id.."SOKAR1:blocname"..msg.chat_id_) or ""
if names_SOKAR1 and names_SOKAR1[1] then 
for i=1,#names_SOKAR1 do 
if name_SOKAR1:match("(.*)("..names_SOKAR1[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, KK_90_name)
end
...
database:set(bot_id.."SOKAR1:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."SOKAR1:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."SOKAR1:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."SOKAR1:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."SOKAR1:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_SOKAR1a_new(SOKAR11,SOKAR12)
if SOKAR12 and SOKAR12.first_name_ then 
if SOKAR12.first_name_:match("(.*)"..database:get(bot_id.."SOKAR1:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."SOKAR1:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local SOKAR1_nnn = database:get(bot_id.."SOKAR1:nump"..msg.chat_id_) or 5
local SOKAR1_nnn2 = database:get(bot_id.."SOKAR1:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(SOKAR1_nnn2) == tonumber(SOKAR1_nnn) or tonumber(SOKAR1_nnn2) > tonumber(SOKAR1_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."SOKAR1:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❃∫ عزيزي >>["..SOKAR12.username_.."](https://t.me/"..(SOKAR12.username_ or "pvv_v")..")\n❃∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."SOKAR1:teh"..msg.chat_id_).."} بجانب اسمك\n❃∫ عدد المحاولات المتبقيه {"..(tonumber(SOKAR1_nnn) - tonumber(SOKAR1_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_SOKAR1a_new)
end
end
...
local SOKAR1ChengName = database:get(bot_id.."SOKAR1:Cheng:Name"..data.id_)
if not data.first_name_ then 
if SOKAR1ChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..SOKAR1ChengName..']')
database:del(bot_id.."SOKAR1:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if SOKAR1ChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."SOKAR1:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local SOKAR1ChengUserName = database:get(bot_id.."SOKAR1:Cheng:UserName"..data.id_)
if not data.username_ then 
if SOKAR1ChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..SOKAR1ChengUserName..']')
database:del(bot_id.."SOKAR1:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if SOKAR1ChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."SOKAR1:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local SOKAR1ChengPhoto = database:get(bot_id.."SOKAR1:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if SOKAR1ChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."SOKAR1:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if SOKAR1ChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."SOKAR1:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
≪━━━━━━𝗦𝗞━━━━━━≫
 ❃∫ ↬SOKAR1 Team
≪━━━━━━𝗦𝗞━━━━━━≫
 ❃∫ ↬[Channel SOKAR1](t.me/SOKAR1_R) 
≪━━━━━━𝗦𝗞━━━━━━≫
 ❃∫ ↬[Information](t.me/SOKAR1_R)
≪━━━━━━𝗦𝗞━━━━━━≫
 ❃∫ ↬[DEVELOPER](t.me/KK_90)
≪━━━━━━𝗦𝗞━━━━━━≫
 ❃∫ ↬[orders SOKAR1](t.me/SOKAR1_R)
≪━━━━━━𝗦𝗞━━━━━━≫
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
if text == 'رفع نسخه الاحتياطيه' and DevSOKAR1(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevSOKAR1(msg) then    
dofile('SOKAR1.lua')  
send(msg.chat_id_, msg.id_, ' ❃∫ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevSOKAR1(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevSOKAR1(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevSOKAR1(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevSOKAR1(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevSOKAR1(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevSOKAR1(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevSOKAR1(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevSOKAR1(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevSOKAR1(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevSOKAR1(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevSOKAR1(msg) then
...
if database:get(bot_id.."KK_90:admin:Time"..msg.chat_id_) then 
return
 send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'KK_90:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."KK_90:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'KK_90:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevSOKAR1(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevSOKAR1(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function Function_SOKAR1(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_SOKAR1, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_SOKAR1, nil)
return false 
end
...
database:set(bot_id.."SOKAR11:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."SOKAR11:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."SOKAR11:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."SOKAR11:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."SOKAR11:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."SOKAR11:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."SOKAR11:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."SOKAR11:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."SOKAR11:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."SOKAR11:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."SOKAR11:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."SOKAR11:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."SOKAR11:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SOKAR11:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."SOKAR11:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."SOKAR11:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."SOKAR11:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SOKAR11:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."SOKAR11:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n≪━━━━━━𝗦𝗞━━━━━━≫\n"
for k,v in pairs(list) do  
local SOKAR1_Msg = database:get(bot_id.."SOKAR11:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..SOKAR1_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevSOKAR1(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ❃∫ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevSOKAR1(msg) then
...
if text == 'تفعيل الاذاعه' and DevSOKAR1(msg) then  
...
if text == 'تعطيل الاذاعه' and DevSOKAR1(msg) then  
...
if not database:get(bot_id..'KK_90:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'KK_90:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سكر').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سكر')
local SOKAR1_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..SOKAR1_Msg[math.random(#SOKAR1_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevSOKAR1(msg) then 
...
if text == ("مسح ردود المطور") and DevSOKAR1(msg) then 
...
if text == ("ردود المطور") and DevSOKAR1(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❃∫ قائمة ردود المطور \n≪━━━━━━𝗦𝗞━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevSOKAR1(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevSOKAR1(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سكر').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevSOKAR1(msg) then   
...
if text == 'تعطيل المغادره' and DevSOKAR1(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOKAR1')..') '
...
-- vardump(data) 
SOKAR1dx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevSOKAR1(msg) then
...
zh = https.request('https://rudi-dev.tk/Amir1/SOKAR1.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ≪━━━━━━𝗦𝗞━━━━━━≫ٴ❃∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ≪━━━━━━𝗦𝗞━━━━━━≫ٴ❃∫○ٴ\n❃∫ 彡 .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/pvv_v)➢ ')
end
...
gk = https.request('https://rudi-dev.tk/Amir2/SOKAR1.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/SOKAR1.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سكر')
...
SOKAR1 = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(SOKAR1)
...
--------------------------------------------------------------------------------------------------------------
SourceSOKAR1(data.message_,data)
...
------------------------------------------------------------------------
local SOKAR1Abot = database:get(bot_id.."SOKAR11:Add:Filter:Rp2"..text..result.chat_id_)   
if SOKAR1Abot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..SOKAR1Abot.."] \n") 
...
------------------------------------------------------------------------
if text then
local SOKAR11_Msg = database:get(bot_id.."SOKAR11:Add:Filter:Rp2"..text..result.chat_id_)   
if SOKAR11_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..SOKAR11_Msg)
